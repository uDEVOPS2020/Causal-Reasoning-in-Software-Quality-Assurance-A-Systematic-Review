...
df = pd.read_csv("data/results_MAJOR_RQ2_ci.csv")

column = "CImethodology"
categories = ['Regression', 'Ensemble', 'Simulation', 'Neural network', 'Propensity score', 'Covariate balancing', 'Instrumental variable']
...
colors = {'Regression': 'tab:orange', 'Ensemble': 'tab:blue', 'Simulation': 'tab:green', 'Neural network': 'tab:purple', 'Propensity score': 'tab:brown', 'Covariate balancing':'tab:red', 'Instrumental variable':'tab:grey'}
...
fig.tight_layout()
plt.show()
fig.savefig('images/years_ci.pdf', bbox_inches='tight', dpi=1000)
