...
df = pd.read_csv("data/results_RQ2_ci.csv")
...
colors = {
    ...
    'Ensemble': 'tab:blue', 
    'Simulation': 'tab:green', 
    'Neural network': 'tab:purple', 
    'Propensity score': 'tab:brown', 
    'Covariate balancing': 'tab:red', 
    'Instrumental variable': 'tab:grey'
}
