...
column = "Category"
categories = ['Constraint-based', 'Score-based', 'FCM-based', 'Time-series', 'Other']
...
colors = {'Constraint-based': 'tab:orange', 'Score-based': 'tab:blue', 'FCM-based': 'tab:green', 'Time-series': 'tab:purple', 'Other': 'tab:grey'}
...
fig.tight_layout()
plt.show()
fig.savefig('images/years_cd.pdf', bbox_inches='tight', dpi=1000)
