...
ax.pie(task_counts, explode=explode, labels=task_counts.index, colors = ["tab:orange","tab:blue","tab:grey"], autopct='%1.1f%%', startangle=90, textprops={'fontsize': fontsize})
ax.axis('equal')
fig.tight_layout()
# plt.show()
